...
function legendClickCallback(a) {
    for (var s = (a = a || window.event).target || a.srcElement; "LI" !== s.nodeName; )
        s = s.parentElement;
    ...
    i.isDatasetVisible(o) ? s.classList.remove("hidden") : s.classList.add("hidden")
}
function readURL(a) {
...
$(document).ready(function() {
    ...
    if (!t) {
        ...
        p.on("click", function() {
            1 == d ? ($("html").removeClass("nav_open"),
            p.removeClass("toggled"),
            d = 0) : ($("html").addClass("nav_open"),
            p.addClass("toggled"),
            d = 1)
        }),
        t = !0
    ...
    if (!l) {
        ...
        u.on("click", function() {
            1 == g ? ($("html").removeClass("topbar_open"),
            u.removeClass("toggled"),
            g = 0) : ($("html").addClass("topbar_open"),
            u.addClass("toggled"),
            g = 1)
        }),
        l = !0
    ...
    if (!c) {
        ...
        b.on("click", function() {
            1 == m ? ($("html").removeClass("pagesidebar_open"),
            b.removeClass("toggled"),
            m = 0) : ($("html").addClass("pagesidebar_open"),
            b.addClass("toggled"),
            m = 1)
        });
